...
class Feature(SubModule):
    def __init__(self):
        ...
        self.bn1 = model.bn1
        # self.act1 = self.bn1(self.conv_stem())
    ...
    def forward(self, x):
        x = self.bn1(self.conv_stem(x))  # Activation is part of bn1, applied automatically
        x2 = self.block0(x)
        x4 = self.block1(x2)
        # return x4,x4,x4,x4
        x8 = self.block2(x4)
...
class hourglass_fusion(nn.Module):
    def __init__(self, in_channels):
        ...
        self.conv1 = nn.Sequential(
                        BasicConv(in_channels*1, in_channels*2, is_3d=True, bn=True, relu=True, kernel_size=3, padding=1, stride=2, dilation=1),
    ...
    def forward(self, x, imgs):
        ...
        # print("conv2_up shape: ", conv2_up.shape)

...
class DatasetFolderScape(Dataset):
    def __init__(self, datapath, list_filename, training):
        self.datapath = datapath
        self.left_filenames, self.right_filenames, self.disp_filenames = self.load_path(list_filename)
        self.training = training
    ...
    def __getitem__(self, index):
        ...
        if self.training:
            ...
            # make grayscale
            left_img = torchvision.transforms.functional.to_grayscale(left_img, num_output_channels=3)
            right_img = torchvision.transforms.functional.to_grayscale(right_img, num_output_channels=3)
            ...
            w, h = left_img.size
            crop_w, crop_h = 768, 576
            # crop_w, crop_h = 1536, 1152
